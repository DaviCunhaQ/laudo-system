...
export default function HandleNewOrderServiceDialog() {
  ...
  const citiesCoordinates = [
    ...
    {
      name: "Novo Oriente",
      coordinates: "-5.5250, -40.7714",
      cep: "63740-000",
    },
    { name: "Pacujá", coordinates: "-3.9833, -40.6986", cep: "62180-000" },
    {
      name: "Pires Ferreira",
      coordinates: "-4.2392, -40.6442",
      cep: "62255-000",
    },
    ...
    {
      name: "Santa Quitéria",
      coordinates: "-4.3269, -40.1528",
      cep: "62280-000",
    },
    {
      name: "Santana do Acaraú",
      coordinates: "-3.4619, -40.2114",
      cep: "62150-000",
    },
    {
      name: "São Benedito",
      coordinates: "-4.0475, -40.8592",
      cep: "62370-000",
    },
