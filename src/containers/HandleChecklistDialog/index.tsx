...
import { documentOptions , artPciVerificationOptions , artRegistrationCompareOptions , decRegistrationCompareOptions , dwellRegistrationOptions , mandatoryDocumentBOptions , minimalDocumentOptions, moreAccurateOptions, pciVerificationsOptions, plsVerificationsOptions , projectPermitVerificationOptions
 } from "@/utils/allOptions";
import { useUpdateOrderService } from "@/hooks/order-services/useUpdateOrderService";
import toast from "react-hot-toast";

export default function HandleChecklistDialog({orderData,id, soType}:{orderData: ServiceOrderListSchema, id: string, soType: string}) {
  const [isOpen, setIsOpen] = useState<boolean>();
  const updateOrderService = useUpdateOrderService()
  const [selectedPropertyType, setSelectedPropertyType] = useState<string>(orderData?.property_type ? orderData.property_type : '')
  const [selectedPropertyStatus, setSelectedPropertyStatus] = useState<string>(orderData?.property_status ? orderData.property_status as string : '')
  const [selectedRegistrationOnSystem, setSelectedRegistrationOnSystem] = useState<string>(orderData?.registration_on_system ? orderData.registration_on_system as string : '')
  const [selectedSiopiCoincides, setSelectedSiopiCoincides] = useState<string>(orderData?.siopi_coincides ? orderData.siopi_coincides as string : '')
  const [selectedRegistrationType, setSelectedRegistrationType] = useState<string>(orderData?.registration_type ? orderData.registration_type as string : '')
  ...
  const {
    ...
    defaultValues: {
        art_registration_compare: orderData?.art_registration_compare ? orderData?.art_registration_compare : undefined,
        averbation_exists: orderData?.averbation_exists ? orderData?.averbation_exists : undefined,
        bathrooms_number: orderData?.bathrooms_number ? orderData?.bathrooms_number : undefined,
        built_area: orderData?.built_area ? orderData?.built_area : undefined,
        built_area_presents: orderData?.built_area_presents ? orderData?.built_area_presents : undefined,
        cnpj: orderData?.cnpj ? orderData?.cnpj : undefined,
        cpf: orderData?.cpf ? orderData?.cpf : undefined,
        dec_registration_compare: orderData?.dec_registration_compare ? orderData?.dec_registration_compare : undefined,
        dwell_registration_compare: orderData?.dwell_registration_compare ? orderData?.dwell_registration_compare : undefined,
        mandatory_documents: orderData?.mandatory_documents ? orderData?.mandatory_documents : undefined,
        mandatory_documents_to_b: orderData?.mandatory_documents_to_b ? orderData?.mandatory_documents_to_b : undefined,
        minimal_documentation: orderData?.minimal_documentation ? orderData?.minimal_documentation : undefined,
        more_accurate_informations: orderData?.more_accurate_informations ? orderData?.more_accurate_informations : undefined,
        pci_art_compare: orderData?.pci_art_compare ? orderData?.pci_art_compare : undefined,
        pci_verifications: orderData?.pci_verifications ? orderData?.pci_verifications : undefined,
        pls_built_situation: orderData?.pls_built_situation ? orderData?.pls_built_situation : undefined,
        pls_verifications: orderData?.pls_verifications ? orderData?.pls_verifications : undefined,
        property_status: orderData?.property_status ? orderData?.property_status : undefined,
        property_type: orderData?.property_type ? orderData?.property_type : undefined,
        registration_date: orderData?.registration_date ? orderData?.registration_date : undefined,
        registration_on_system: orderData?.registration_on_system ? orderData?.registration_on_system : undefined,
        registration_type: orderData?.registration_type ? orderData?.registration_type : undefined,
        rooms_number: orderData?.rooms_number ? orderData?.rooms_number : undefined,
        project_permit_verifications: orderData?.project_permit_verifications ? orderData?.project_permit_verifications : undefined,
        siopi_coincides: orderData?.siopi_coincides ? orderData?.siopi_coincides : undefined,
        total_measured: orderData?.total_measured ? orderData?.total_measured : undefined,
        terrain_area: orderData?.terrain_area ? orderData?.terrain_area : undefined,
    },
  });

  const [value, setValueLocal] = useState(orderData?.cpf ? orderData.cpf : orderData?.cnpj ? orderData.cnpj : "");
