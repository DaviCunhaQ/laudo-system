...
export const dwellRegistrationOptions = [
...
export const artRegistrationCompareOptions = [
...
export const decRegistrationCompareOptions = [
...
export const minimalDocumentOptions = [
...
export const plsVerificationsOptions = [
...
export const moreAccurateOptions = [
...
export const pciVerificationsOptions = [
...
export const artPciVerificationOptions =[
  { label: "Endereço da obra", value: "Endereço da obra" },
  { label: "Proprietário", value: "Proprietário" },
  { label: "Área construída", value: "Área construída" },
...
export const projectPermitVerificationOptions =[
